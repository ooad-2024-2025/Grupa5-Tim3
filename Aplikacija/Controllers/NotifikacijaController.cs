...
namespace Grupa5Tim3.Controllers
{
    public class NotifikacijaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("notifikacijaID,tipObavijesti,kodQR,verifikacijskiKod,umjetninaID,korisnikID")] Notifikacija notifikacija)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("notifikacijaID,tipObavijesti,kodQR,verifikacijskiKod,umjetninaID,korisnikID")] Notifikacija notifikacija)
        {
